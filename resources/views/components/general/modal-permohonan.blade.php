<div x-show="{{$modalActive}}" style="display: none;" class="fixed inset-0 z-40 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        >
            ...
            <div>
                <div class="">
                    <div class="flex items-center justify-between font-semibold bg-indigo-500 py-2 px-2">
                        ...
                        <a href="{{$route}}" class="cursor-pointer rounded-full bg-red-500 hover:bg-red-600 border-2 border-white py-1 px-1" @click="{{$modalActive}} = false">
                            <x-heroicon-o-x class="w-4 h-4 text-white font-bold"/>
                        </a>
                        @endif
                    </div>
