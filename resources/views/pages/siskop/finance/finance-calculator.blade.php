    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="flex flex-col-reverse col-span-12 lg:col-span-6 xxl:col-span-6 lg:block">
            <x-general.card class="bg-white shadow-lg p-4">
                ...
                <div class="">
                    <div x-data="{ isOpen1: true}">
                        <button
                            class="text-{{auth()->user()->primary_color}}-500 flex items-center justify-between w-full py-3 font-semibold border-b border-gray-400 focus:outline-none"
                            @click="isOpen1 = !isOpen1">
                            <h1 class="font-semibold">Product Defination</h1>
                            <svg x-show="!isOpen1" class="fill-current" viewBox="0 0 24 24" width="24" height="24" x-cloak>
                                ...
                                <x-form.basic-form action="">
                                    <x-slot name="content">
                                        <div class="grid gap-2 lg:grid-cols-2 sm:grid-cols-2">
                                            <x-form.input label="Account No" value="" livewire="wire:model=account_no" :editable=false/>

                                            <x-form.dropdown label="Product" value="product_id" :editable=true>
                                                @forelse ($products as $item)
                                                    <option value="{{ $item->id }}">{{ $item->product_desc }}</option>
                                                @empty @endforelse
                                            </x-form.dropdown>
                                        </div>

                                        <div class="grid gap-2 lg:grid-cols-2 sm:grid-cols-2">
                                            <x-form.dropdown label="Concept" value="concept_id" :editable=true>
                                            ...
                                            {{-- <div class="mt-3 grid gap-2 lg:grid-cols-2 sm:grid-cols-1">
                                                <x-form.input label="Facility Type" value="" livewire="" />

                                                <x-form.dropdown label="" value="" :editable=false
                                                    style="margin-top: 22px;">
                                                    <option value=""></option>
                                                </x-form.dropdown>
                                            </div>
                                            <div class="mt-3 grid gap-2 lg:grid-cols-2 sm:grid-cols-1">
                                                <x-form.input label="Purpose Code" value="" livewire="" />
                                            ...
                                            <div class="mt-3 grid gap-2 lg:grid-cols-2 sm:grid-cols-1">
                                                <x-form.input label="Special Fund Scheme" value="" livewire="" />
                                            ...
                                            <div class="mt-3 grid gap-2 lg:grid-cols-2 sm:grid-cols-1">
                                                <x-form.input label="Pns Sectoral Code" value="" livewire="" />
                                            ...
                                            <div class="">
                                                <x-form.input type="date" label="Approve Date" value="" livewire="wire:model=approved_date" :editable=true/>
                                            </div>
                                        </div>
                                    </x-slot>
                                </x-form.basic-form>
                        ...
                        <div class="mt-2 text-sm text-gray-700" x-show="isOpen2">
                            <div class="p-3">
                                <x-form.basic-form action="">
                                    <x-slot name="content">
                                        <div class="grid gap-2 lg:grid-cols-2 sm:grid-cols-2">
                                            <x-form.input label="Financing Amount" value="" livewire="wire:model=financing_amount" :editable=true/>

                                            <x-form.input label="Profit Rate" value="" livewire="wire:model=profit_rate" :editable=true/>

                                            <x-form.input label="Duration (Months)" value="" livewire="wire:model=duration" :editable=true/>

                                            {{-- <x-form.input label="Grace period (Months)" value="" livewire="" /> --}}

                                            <x-form.dropdown label="Profit Calculation Mode" value="calculation_method" :editable=true>
                                                <option value="Flat Rate">Flat Rate</option>
                                                {{-- <option value="Reducing Balance">Reducing Balance</option> --}}
                                            </x-form.dropdown>

                                            {{-- <x-form.dropdown label="Instalment Mode" value="" :editable=false>
                                                <option value=""></option>
                                            </x-form.dropdown> --}}
        ...
        <div class="col-span-12 lg:col-span-6 xxl:col-span-6">
            ...
            <div class="">
                <x-general.card class="bg-white shadow-lg p-4">
                    <div class="flex justify-between">
                        <h1 class="font-semibold text-{{auth()->user()->primary_color}}-500">Step-Up Instalment</h1>
                    </div>
            ...
            <div class="mt-4">
                <x-general.card class="bg-white shadow-lg p-4">
                    <div class="flex justify-between">
                        <h1 class="font-semibold text-{{auth()->user()->primary_color}}-500">Multiple Step-Up/Down
                            Installment</h1>
                    </div>
                    <div class="pt-4">
                        <div class="my-4 flex justify-between">
