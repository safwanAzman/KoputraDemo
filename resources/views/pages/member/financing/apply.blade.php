            ...
            <div class="w-full">
                <div x-show.transition="step != 'complete'">
                    ...
                    <div class="px-4 py-4  overflow-y-auto" style="height: 28rem;">
                        <div x-show.transition.in="step === 1">
                            <x-form.basic-form>
                                <x-slot name="content">
                                    <div class="font-semibold text-lg text-indigo-600 border-b-4 border-indigo-600 py-2">
                                        <p>MAKLUMAT PERIBADI</p>
                                    </div>
                                    <x-general.grid mobile="1" gap="5" sm="1" md="1" lg="2" xl="2" class="col-span-6 mt-6">
                                        <x-form.input label="Nama Penuh :"  value="" />
                                        <x-form.input label="No.K/P Baru :"  value="" />
                                    ...
                                    <x-general.grid mobile="1" gap="5" sm="1" md="1" lg="1" xl="1" class="col-span-6 mt-3">
                                        <x-form2.address class="" label="Alamat"  value1="" value2="" value3="" value4="" value5=""
                                    ...
                                    <x-general.grid mobile="1" gap="5" sm="1" md="2" lg="2" xl="2" class="col-span-6 mt-3">
                                        ...
                                        <div>
                                            <span class="block text-sm font-semibold leading-5 text-gray-700">Taraf Perkahwinan :</span>
                                            <div class="mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" class="form-radio" name="name" value="l">
                                    ...
                                    <div class="font-semibold text-lg text-indigo-600 border-b-4 border-indigo-600 py-2 mt-6">
                        ...
                        <div x-show.transition.in="step === 2">
                            <div class="p-4">
                                <p class="text-xs text-gray-400">Nota: Sila pastikan dokumen sokongan adalah jelas dan telah disahkan oleh majikan.</p>
                ...
                <div class="flex justify-center mt-4">
                    <div class="flex justify-between">
                        ...
                        <button x-show="step === 1" onclick="save()"
