    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-2/5 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
            <div class="w-full h-100">
                ...
                <h1 class="text-xl md:text-2xl font-bold leading-tight mt-12">Reset password</h1>
                @if ($emailSentMessage)
                ...
                @else
                    <form wire:submit.prevent="sendResetPasswordLink" class="mt-6">
                        <div>
                            <div class="mt-1 rounded-md shadow-sm">
                                <input wire:model.lazy="email" id="email" name="email" type="email" required autofocus  placeholder="Enter Email Address"
