...
Route::middleware('guest')->group(function () {
    ...
    Route::get('nonmembers/1', [NonMemberController::class, 'dashboard2'])->name('non-member2');
    ...
    Route::get('members/{uuid}', [SiskopController::class, 'finance_show'])->name('member-show');
